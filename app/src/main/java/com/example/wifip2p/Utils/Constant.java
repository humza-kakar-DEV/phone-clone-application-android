...
public class Constant {
    public static final String THREAD_DATA_SEND = "hmSend";
    public static final String THREAD_DATA_RECEIVED = "hmReceived";
    public static final String MAIN_ACTIVITY_TAG = "hmMainActivity";
    public static final String GROUP_OWNER_TAG = "hmHostAddress";
    public static final String CONNECTION_TAG = "hmConnection";
    public static final String THREAD_TAG = "hmThread";
