...
//                ************** RECEIVING OBJECT THROUGH CLIENT SOCKET **********
                ...
                if (dynamicObject.getObjectType().equals("audio")) {
                    Audio audio = (Audio) dynamicObject.getObject();
                    Log.d(TAG, "handleMessage: file type: " + audio.getClassName());
                    Toast.makeText(mainActivity, "file type: " + audio.getClassName(), Toast.LENGTH_SHORT).show();
                }
